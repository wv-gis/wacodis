...
/**
 * component for selection of reservoir to plot the water management graph for
 */
export class SelectionViewComponent implements OnInit {
  ...
  /**
   * on selection of reservoir plot the graph for ID
   * @param id selected reservoirID
   */
  ...
  /**
    * define which reservoir the report should be created for and set timespan
